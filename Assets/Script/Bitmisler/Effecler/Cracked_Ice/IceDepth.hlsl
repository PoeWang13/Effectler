void IceDepth_half(in Texture2D MainTex, in float2 UV, in SamplerState SS, in float Samples,
				   in float Offset, in float3 WPOS, in float Lerp, in int LOD, out float4 Out)
{
	half4 col = 0;
	half u_off = 0;
	half v_off = 0;
